            ...
            <div className="limiter">
                <div className="container-register">
                    <div className="wrap-register">
                        <div className="register-pic js-tilt" data-tilt=""><img src={require('../images/img-02.png')} alt=
                            "IMG" /></div>
                        ...
                        <form className="register-form validate-form">
                            ...
                            <div className="wrap-input ">
                                <input className="input" type="text" name="username" placeholder="Username" required ref={(username) => this.username = username} />
                            </div>
                            ...
                            <div className="text-center">
                                <span className="txt2">Already have an account ?<a className="txt2" href="Login"> Log In</a></span>
                            </div>
                            {this.state.msg !== "" ?
