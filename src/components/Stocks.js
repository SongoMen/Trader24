...
export default class Stocks extends React.Component {
  ...
  getStocksList() {
    const stocks =
      "https://api-v2.intrinio.com/companies?api_key=OjNmMmQyMjFlZmU5NDAzNWQ2ZWIyNmRhY2QxNzIzMjM2";
    fetch(stocks)
      .then((res) => res.json())
      .then((result) => {
        for (let i = 0; i < 12; i++) {
          ...
          const lastPrice = `https://api-v2.intrinio.com/securities/${
            stockListTickers[i]
          }/prices/realtime?api_key=OjNmMmQyMjFlZmU5NDAzNWQ2ZWIyNmRhY2QxNzIzMjM2`;
          const logo = `https://api-v2.intrinio.com/companies/${
            stockListTickers[i]
          }?api_key=OjNmMmQyMjFlZmU5NDAzNWQ2ZWIyNmRhY2QxNzIzMjM2`;
          fetch(lastPrice)
            .then((res) => res.json())
            .then((result) => {
              if ("Note" in result) {
              ...
              let lastPrice = parseFloat(result.last_price).toFixed(2);
          ...
          fetch(logo)
            ...
            .then((result) => {
              ...
              stockListLogos[i] =
                "http://logo.clearbit.com/" + result.company_url;
              setTimeout(() => {
                this.setState({
                  loader3: true
                });
        ...
        <div className="leftbar">
          ...
          <ul className="leftbar__menu">
            ...
            <li onClick={() => this.routeChange("/stocks")}>
              ...
              <h4 style={{color: "#383d73"}}>All Stocks</h4>
            </li>
          </ul>
        ...
        <ul className="allStocks__list">
          {stockList.map((value, index) => {
            return (
              <li key={index}>
                <span>
                  <img alt="" src={stockListLogos[index]} />
                  <h4>{value}</h4>
                </span>
